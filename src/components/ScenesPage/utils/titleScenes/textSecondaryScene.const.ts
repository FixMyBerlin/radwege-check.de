...
export const textNoCarsAndBicycleStreetType = {
  none: "Radverkehrsführung in autofreier Nebenstraße",
  bicycle_road: "Radverkehrsführung in autofreier Fahrradstraße",
...
export const textCarriagewayDirection = {
  both_directions: "in beiden Richtungen",
  one_way: "auf Einbahnstraße in Fahrtrichtung",
  one_way_for_cars_only: "auf gegenläufiger Einbahnstraße",
};

export const textParkingCategory = {
  no_parking: null,
  parking_one_side: "mit Parken rechts",
  parking_both_sides: "mit beidseitigem Parken",
};
